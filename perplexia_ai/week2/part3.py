...
class CorrectiveRAGlite(ChatInterface):
    ...
    #page_content= [page_content for doc in documents for page_content in doc.page_content]
    #uuids= [metadata for doc in documents for metadata in doc.metadata]

    vector_store = Chroma.from_documents(
        documents,
        collection_name="OPMdocuments",
